...
class Component_AttachmentUpload
{
    protected $options;
    ...
    function __construct($options = null, $initialize = true) {
        $this->options = array(
            ...
            'inline_file_types' => '/\.(pdf|doc?x)$/i',
            // Defines which files (based on their names) are accepted for upload:
            'accept_file_types' => '/\.(pdf|doc?x)$/i',
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
                ...
                if ($append_file) {
                    ...
                    $oLibAttachment = new Object_LibAttachment();
                    $file->id = $oLibAttachment->save(
                    		null, array(),
                    		array(
