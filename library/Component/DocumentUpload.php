...
class Component_DocumentUpload
{
    ...
    protected $error_messages = array(
        ...
        'accept_file_types' => 'Filetype not allowed. Files can be either a Word document, PDF, JPG image or TIFF.',
    ...
    function __construct($options = null, $initialize = true) {
        $this->options = array(
            ...
            'inline_file_types' => '/\.(pdf|doc?x|jpe?g|tiff)$/i',
            // Defines which files (based on their names) are accepted for upload:
            'accept_file_types' => '/\.(pdf|doc?x|jpe?g|tiff)$/i',
