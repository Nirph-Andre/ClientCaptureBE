 ...
 */
class Table_AssetSubDescription extends Struct_Abstract_ModelTable
{

    /**
     * Database table name.
     */
    protected $_name = 'asset_sub_description';

    /**
     * Data associations to other tables.
     */
    protected $_referenceMap = array('AssetDescription' => array(
    ...
    protected $_metadata = array(
        'id' => array(
            'SCHEMA_NAME' => null,
            'TABLE_NAME' => 'asset_sub_description',
            'COLUMN_NAME' => 'id',
            'COLUMN_POSITION' => 1,
            'DATA_TYPE' => 'int',
            'DEFAULT' => null,
     ...
     * Label format for list/dropdown display.
     */
    protected $labelFormatForeign = '[asset_sub_description_name]';
