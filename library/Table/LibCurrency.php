 ...
 */
class Table_LibCurrency extends Struct_Abstract_ModelTable
{

    /**
     * Database table name.
     */
    protected $_name = 'lib_currency';
    ...
    protected $_dependentTables = array(
        'bill_invoice' => 'Table_BillInvoice',
        'config' => 'Table_Config'
        );
     ...
     * Label format for list/dropdown display.
     */
    protected $labelFormatForeign = '[lib_currency_name]';
