 ...
 */
class Table_LibPerson extends Struct_Abstract_ModelTable
{

    /**
     * Database table name.
     */
    protected $_name = 'lib_person';
     ...
     * Label format for list/dropdown display.
     */
    protected $labelFormatForeign = '[lib_person_first_name]';
