 ...
 */
class Table_PoleLength extends Struct_Abstract_ModelTable
{

    /**
     * Database table name.
     */
    protected $_name = 'pole_length';
     ...
     * Label format for list/dropdown display.
     */
    protected $labelFormatForeign = '[pole_length_name]';
