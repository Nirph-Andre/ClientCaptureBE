 ...
 */
class Table_StreetLightType extends Struct_Abstract_ModelTable
{

    /**
     * Database table name.
     */
    protected $_name = 'street_light_type';
     ...
     * Label format for list/dropdown display.
     */
    protected $labelFormatForeign = '[street_light_type_name]';
